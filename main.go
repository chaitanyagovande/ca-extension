...
import (
	...
	"github.com/chaitanyagovande/ca-extension/commands"
	"github.com/jfrog/jfrog-cli-core/v2/plugins"
	"github.com/jfrog/jfrog-cli-core/v2/plugins/components"
	//"ca-extension/commands"
)
...
func getApp() components.App {
	app := components.App{}
	app.Name = "ca-extension"
	app.Description = "Curation Audit Extension to provide curation-audit capabilities for new package managers."
	app.Version = "v0.1"
...
func getCommands() []components.Command {
	...
	return []components.Command{
		commands.GetCaExtensionCommand()}
}
